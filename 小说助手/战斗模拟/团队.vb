...
Namespace 战斗模拟
	...
	End Interface
	Interface I有成员列表
		ReadOnly Property 成员列表 As 实时更新列表
	End Interface
	Class 团队
		Inherits 战斗单位
		...
		ReadOnly Property 成员列表 As New 实时更新列表 Implements I有成员列表.成员列表
		...
		Public Function 安排战斗计划(敌队 As IReadOnlyCollection(Of I战场团队)) As IReadOnlyCollection(Of I战场统计) Implements I战场团队.安排战斗计划
			Dim a As New Collection(Of I团队成员)
			For Each b As 团队 In 敌队
				For Each c As I团队成员 In b.成员列表
					a.Add(c)
				Next
			Next
			Dim d As New Collection(Of I战场统计)
			For Each c As I团队成员 In 成员列表
